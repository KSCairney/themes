$(document).ready(function(){
    ...
    $('#proj00').click(function(){
        ...
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj01').click(function(){
        $('#proj01').addClass('blackout');
        $('#proj00, #proj02, #proj03, #proj04, #proj05, #proj06, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj02').click(function(){
        $('#proj02').addClass('blackout');
        $('#proj01, #proj00, #proj03, #proj04, #proj05, #proj06, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj03').click(function(){
        $('#proj03').addClass('blackout');
        $('#proj01, #proj02, #proj00, #proj04, #proj05, #proj06, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj04').click(function(){
        $('#proj04').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj00, #proj05, #proj06, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj05').click(function(){
        $('#proj05').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj04, #proj00, #proj06, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj06').click(function(){
        $('#proj06').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj00, #proj07, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj07').click(function(){
        $('#proj07').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj00, #proj08, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj08').click(function(){
        $('#proj08').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj00, #proj07, #proj09, #proj10').removeClass('blackout')
    });
    $('#proj09').click(function(){
        $('#proj09').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj00, #proj07, #proj08, #proj10').removeClass('blackout')
    });
    $('#proj10').click(function(){
        $('#proj10').addClass('blackout');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj00, #proj07, #proj08, #proj09').removeClass('blackout')
    });
