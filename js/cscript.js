$(document).ready(function(){
    $('#proj00').click(function(){
        ...
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj07').removeClass('chosen')
    });
    $('#proj01').click(function(){
        $('#proj01').addClass('chosen');
        $('#proj00, #proj02, #proj03, #proj04, #proj05, #proj06, #proj07').removeClass('chosen')
    });
    $('#proj02').click(function(){
        $('#proj02').addClass('chosen');
        $('#proj01, #proj00, #proj03, #proj04, #proj05, #proj06, #proj07').removeClass('chosen')
    });
    $('#proj03').click(function(){
        $('#proj03').addClass('chosen');
        $('#proj01, #proj02, #proj00, #proj04, #proj05, #proj06, #proj07').removeClass('chosen')
    });
    $('#proj04').click(function(){
        $('#proj04').addClass('chosen');
        $('#proj01, #proj02, #proj03, #proj00, #proj05, #proj06, #proj07').removeClass('chosen')
    });
    $('#proj05').click(function(){
        $('#proj05').addClass('chosen');
        $('#proj01, #proj02, #proj03, #proj04, #proj00, #proj06, #proj07').removeClass('chosen')
    });
    $('#proj06').click(function(){
        $('#proj06').addClass('chosen');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj00, #proj07').removeClass('chosen')
    });
    $('#proj07').click(function(){
        $('#proj07').addClass('chosen');
        $('#proj01, #proj02, #proj03, #proj04, #proj05, #proj06, #proj00').removeClass('chosen')
    });
